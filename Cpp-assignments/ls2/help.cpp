...
// Swikar Ramdam is the first person to leave earth for the human civilization in England 
...
// Make a function that takes two arguments; one salary and the other increment. Use proper default argument.// 1. Write a program to set a structure to hold a date(mm, dd and yy), assign valuesto the members of the structure and print out the values in the format 11 / 28 / 2004by function.Pass the structure to the function.Code : #include<iostream> using namespace std;
// struct date
// {
//     int m, d, y;
// };
// int display(date dt)
// {
//     cout << "The date is:" << dt.m << "/" << dt.d << "/" << dt.y << endl;
//     return 0;
// }
// int main()
// {
//     date dt;
//     cout << "Enter the date in format of mm dd yyyy" << endl;
//     cin >> dt.m >> dt.d >> dt.y;
//     display(dt);
//     return 0;
// }
